...
REP 연동을 위한 브라우저용 Web SDK입니다.

이 제품 항목은 upstream 소스 저장소에서 빌드한 REP Web SDK 패키지를 내려받기 위한 진입점입니다.

## 링크

- 소스 저장소: https://github.com/Conalog/rep
- 릴리즈 페이지: https://github.com/Conalog/publish/releases
- 릴리즈 태그 패턴: `rep-web-sdk/vX.Y.Z`
...
같은 릴리즈의 `rep-web-sdk_<version>_SHA256SUMS.txt`로 다운로드한 asset의 체크섬을 검증합니다.

## 참고

Web SDK asset은 플랫폼에 독립적이므로 OS 또는 architecture token을 사용하지 않습니다.
